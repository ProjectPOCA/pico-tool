...
DEFAULT_LOG_PATH = "/state/vusion_2in06_runtime_log.txt"
DEFAULT_RUN_PATH = "/state/vusion_2in06_runtime_run_id.txt"
...
CAL_BLACK_BIN = "/images/pac/poca_calibration_2in06_black.bin"
CAL_RED_BIN = "/images/pac/poca_calibration_2in06_red.bin"
CAL_YELLOW_BIN = "/images/pac/poca_calibration_2in06_yellow.bin"
...
class Runtime:
    ...
    def __init__(self, backend, cfg=None):
        ...
        self.science_bmp_dir = cfg.get("science_bmp_dir", "/images/fonts/science_gothic/bmp/2.06")
    ...
    def run(self):
        ...
        self.log("=== 2IN06 RUNTIME RUN {} START ===".format(run))
